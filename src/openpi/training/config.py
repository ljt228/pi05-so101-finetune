...
class DataConfig:
    ...
    # Optional video backend override for LeRobot video decoding, e.g. "pyav".
...
class LeRobotSO101DataConfig(DataConfigFactory):
    """Data config for SO-101 style LeRobot datasets with one global and one wrist camera."""
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotSO101DataConfig(
            ...
            default_prompt="first put the block onto the plate, move the plate to the center of the table, place the spoon on the right side of the plate, and place the cup on the left side of the plate.",
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
        freeze_filter=pi0_config.Pi0Config(
            pi05=True,
